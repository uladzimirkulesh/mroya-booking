...
?>
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x( 'Header (default)', 'Name for the Default header pattern', 'mroya-booking' ); ?>"},"className":"header__inner has-global-padding","layout":{"type":"constrained"}} -->
<div class="wp-block-group header__inner has-global-padding">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10)">
		...
		<!-- wp:navigation {"overlayBackgroundColor":"accent-4","style":{"layout":{"selfStretch":"fixed","flexSize":"50%"}},"layout":{"type":"flex","justifyContent":"right","flexWrap":"nowrap"}} /-->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
