...
<div class="wp-block-group alignwide page-header__inner--blog-1">
	...
	<h1 class="wp-block-heading alignwide is-style-text-giant page-header__title"><?php echo wp_kses_post( _x( 'Nur mit<br>Aussicht', 'Blog page header title', 'mroya' ) ); ?></h1>
	<!-- /wp:heading -->
