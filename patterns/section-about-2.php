	...
	<div class="wp-block-group alignwide section__content">
		...
		<div class="wp-block-group advantages">
			...
			<div class="wp-block-group advantages__item" style="border-left-color:var(--wp--preset--color--contrast-4);border-left-style:solid;border-left-width:2px;padding-top:0.5rem;padding-bottom:0.5rem;padding-left:2rem">
				...
				<!-- wp:paragraph -->
				<p><?php echo esc_html_x( 'Raum mit Weite, Licht und Blick auf die Drei Schwestern.', 'Advantages item text', 'mroya-booking' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group advantages__item" style="border-left-color:var(--wp--preset--color--contrast-4);border-left-style:solid;border-left-width:2px;padding-top:0.5rem;padding-bottom:0.5rem;padding-left:2rem">
				...
				<!-- wp:paragraph -->
				<p><?php echo esc_html_x( 'Von fokussierten Meetings bis zu lebendigen Workshops.', 'Advantages item text', 'mroya-booking' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group advantages__item" style="border-left-color:var(--wp--preset--color--contrast-4);border-left-style:solid;border-left-width:2px;padding-top:0.5rem;padding-bottom:0.5rem;padding-left:2rem">
				...
				<!-- wp:paragraph -->
				<p><?php echo esc_html_x( 'Tische klappbar, Stühle stapelbar, das Sofa bleibt.', 'Advantages item text', 'mroya-booking' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-group block--text">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-buttons">
					<!-- wp:button -->
					<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html_x( 'Jetzt buchen', 'About section button text', 'mroya-booking' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
